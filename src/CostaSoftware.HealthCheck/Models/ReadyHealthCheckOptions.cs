...
{
    public class ReadyHealthCheckOptions : HealthCheckOptions
    {
        private readonly string description;

        public ReadyHealthCheckOptions(string description)
        {
            ...
            Predicate = (r) => r.Tags.Any(t => t.Equals("READY", StringComparison.OrdinalIgnoreCase));
